...
public class FlutterMindWaveMobile2Plugin implements FlutterPlugin, MethodCallHandler {
  ...
  private TgStreamHandler callback = new TgStreamHandler() {
    ...
    public void onStatesChanged(int connectionStates) {
      Log.d(TAG, "State Change  Suman");
      switch (connectionStates) {
        case ConnectionStates.STATE_CONNECTED:
        Log.d(TAG, "Connected Suman900");
          mTgStreamReader.start();
          connectionChannel.invokeMethod("connected", null);
          Log.d(TAG, "Connected Suman");
          break;
        case ConnectionStates.STATE_DISCONNECTED:
        Log.d(TAG, "Disconnected Suman");
          connectionChannel.invokeMethod("disconnected", null);
          disconnect();
          break;
        case ConnectionStates.STATE_GET_DATA_TIME_OUT:
        Log.d(TAG, "Disconnected called by STATE_GET_DATA_TIME_OUT:");   
        disconnect();
        break;
        
        case ConnectionStates.STATE_ERROR:
        Log.d(TAG, "Disconnected called bySTATE_ERROR:");   
        disconnect();
        break;
        case ConnectionStates.STATE_FAILED:
        Log.d(TAG, "Disconnected called by error: STATE_FAILED");   
          disconnect();
          break;
        default:
          break;
    ...
    try {
      switch(call.method)
      {
        ...
        case "connect":
          ...
          connect(deviceId);
          result.success(null);
          Log.d(TAG, "case connected called");
          break;
        case "disconnect":
        Log.d(TAG, "case Disconnected called");
          disconnect();
          result.success(null);
          break;
        default:
      ...
      new Handler(Looper.getMainLooper()).post(new Runnable() {
        ...
        public void run() {
          try {
            ...
            mTgStreamReader.close(); // This can throw IOException
